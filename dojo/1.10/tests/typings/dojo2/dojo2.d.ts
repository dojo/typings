declare module 'dojo2/interfaces' {
...
declare module 'dojo2/aspect' {
	import core = require('dojo2/interfaces');
...
declare module 'dojo2/Evented' {
	import core = require('dojo2/interfaces'); class Evented {
...
declare module 'dojo2/on' {
	import core = require('dojo2/interfaces');
	import Evented = require('dojo2/Evented'); module on {
...
declare module 'dojo2/CallbackQueue' {
	import core = require('dojo2/interfaces'); class CallbackQueue<T extends Function> {
	    private _callbacks;
...
declare module 'dojo2/loader' {
	import has = require('dojo2/has');
...
declare module 'dojo2/has' {
	import loader = require('dojo2/loader'); module has {
	    interface IHas {
	        (name: string): any;
...
declare module 'dojo2/nextTick' {
	import core = require('dojo2/interfaces'); var nextTick: (callback: () => void) => core.IHandle;
	export = nextTick;

}
declare module 'dojo2/kernel' {
...
declare module 'dojo2/DateObject' {
	import core = require('dojo2/interfaces'); class DateObject implements core.IDateObject {
...
declare module 'dojo2/Registry' {
	import core = require('dojo2/interfaces'); module Registry {
	    interface ITest {
	        (...args: any[]): boolean;
	    }
...
declare module 'dojo2/request' {
	import Promise = require('dojo2/Promise');
	import Registry = require('dojo2/Registry'); module request {
...
declare module 'dojo2/request/xhr' {
	import Promise = require('dojo2/Promise');
	import request = require('dojo2/request'); module xhr {
...
declare module 'dojo2/request/node' {
	import Promise = require('dojo2/Promise');
	import request = require('dojo2/request'); module node {
...
declare module 'dojo2/Scheduler' {
	import core = require('dojo2/interfaces'); class Scheduler {
...
declare module 'dojo2/Observable' {
	import core = require('dojo2/interfaces'); class Observable implements core.IObservable {
	    private _callbacks;
...
declare module 'dojo2/ObservableProperty' {
	import core = require('dojo2/interfaces');
	import Observable = require('dojo2/Observable'); class ObservableProperty<T> extends Observable {
	    private _observable;
...
declare module 'dojo2/domReady' {
	import loader = require('dojo2/loader');
...
declare module 'dojo2/text' {
	import loader = require('dojo2/loader');
	export function load(resourceId: string, require: loader.IRequire, load: (value?: any) => void): void;

}
declare module 'dojo2/on/once' {
	import on = require('dojo2/on'); function once(type: string): on.IExtensionEvent;
	export = once;

}
declare module 'dojo2/on/pausable' {
	import core = require('dojo2/interfaces');
	import on = require('dojo2/on'); module pausable {
...
declare module 'dojo2/ObservableArray' {
	import core = require('dojo2/interfaces'); class ObservableArray<T> implements core.IObservableArray<T> {
	    [index: number]: T;
	    length: number;
