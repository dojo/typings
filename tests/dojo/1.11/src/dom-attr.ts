    ...
    registerSuite({
        ...
        ".set": {
            ...
            "node + name + function": function () {
				...
				// NOTE stub cast to any
                domProp.set = (<any> function (node, name, value) {
                    setNode = node;
                    setName = name;
                    setValue = value;
                })
            ...
            "node + 'style' + dictionary": function () {
                ...
                domStyle.set = <any> function (node, value) {
					// TODO these are globals. fix these in the dojo/tests.
                    setNode = node;
                    setValue = value;
                }
        ...
        "validation tests": (function () {
            ...
            return {
                ...
                "attr_map": function () {
					...
					// TODO fix this accidental global in dojo/tests
