...
import JSON = require('dojo/json');
	...
	registerSuite({
		...
		'.toObject': function () {
			...
			(<HTMLInputElement> dom.byId('f6_checkbox1')).checked = false;
			(<HTMLInputElement> dom.byId('f6_checkbox2')).checked = true;
			(<HTMLInputElement> dom.byId('f6_radio1')).checked = true;
			assert.deepEqual(domForm.toObject('f6'), f6_1);

			(<HTMLInputElement> dom.byId('f6_checkbox1')).checked = true;
			assert.deepEqual(domForm.toObject('f6'), f6_2);

			// reset to defaults
			(<HTMLInputElement> dom.byId('f6_checkbox1')).checked = true;
			(<HTMLInputElement> dom.byId('f6_checkbox2')).checked = false;
			(<HTMLInputElement> dom.byId('f6_radio2')).checked = true;
		},
