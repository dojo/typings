    ...
    registerSuite({
        ...
        "names": {
            "maps values correctly": function () {
                ...
                //assert
                assert.equal((<any> domProp).names["class"], "className");
                assert.equal((<any> domProp).names["for"], "htmlFor");
                assert.equal((<any> domProp).names["tabindex"], "tabIndex");
                assert.equal((<any> domProp).names["readonly"], "readOnly");
                assert.equal((<any> domProp).names["colspan"], "colSpan");
                assert.equal((<any> domProp).names["frameborder"], "frameBorder");
                assert.equal((<any> domProp).names["rowspan"], "rowSpan");
                assert.equal((<any> domProp).names["textcontent"], "textContent");
                assert.equal((<any> domProp).names["valuetype"], "valueType");
