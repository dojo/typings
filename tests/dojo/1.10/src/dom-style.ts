    ...
    registerSuite({
        ...
        "get()": {
                ...
                "node + 'opacity'": function () {
                    if (has("ie") < 9 || (has("ie") < 10 && has("quirks"))) {
                        ...
                        //assert
                        assert.equal(parseFloat(<string> result).toFixed(4), value.toFixed(4));
                    }
                },
        ...
        "set()": {
                ...
                "node + aliases of float": function () {
                    ...
                    container.appendChild(node);
					// TODO FIXME float is a reserved word in JS use cssFloat (styleFloat for IE8-)
                ...
                "node + opacity + number": function() {
                    ...
                    var node = document.createElement("div"),
                        style = "opacity",
                        value = "0.3"; // TODO missing ; should be string.
                ...
                "node": function () {
					// TODO what is the point of this test? That domStyle.set(node) does nothing?
                    //arrange
                    var node = document.createElement("div"),
                        map = {
                            position: "relative",
                    ...
                    //act
                    var result = (<any> domStyle).set(node);
