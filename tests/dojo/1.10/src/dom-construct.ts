        ...
        "toDom": (function () {
            return {
                ...
                "returns expected result when tree requested": function () {
                    ...
                    //act
                    var result:any = domConstruct.toDom(parent.outerHTML);

                    //assert
					// TODO cast required. Context is needed to know the specific type of Node returned.
                ...
                "returns expected result when forest requested": function () {
                    ...
                    //act
					// TODO cast required. Call context necessary to know specific type of node.
                    var result:any = domConstruct.toDom(parent.innerHTML);
            ...
            return {
                ...
                "when third argument is a number that is greater than the number of children in the reference, then the first arg is placed as the first child of second": function () {
                    ...
                    var node = document.createElement("span"),
						...
						// TODO investigate if this is correct usage
                        position:string = (<any> children) + 42;
        ...
        "empty": (function () {
            return {
                ...
                "when given an svg element, then it is emptied": function () {
					...
					// TODO FIXME TypeScript Typings incorrectly place innerHTML on HTMLElement instead of Element
					(<any> svg).innerHTML = "<rect></rect>";

                    //act
                    domConstruct.empty(svg);

                    //assert
					// TODO svg has Element.children starting in IE 9.
                    assert.equal((<any> svg).children.length, 0);
                }
            };
        })(),
        "destroy": (function () {
